...
def main(_):
    ...
    wandb.init(name="connector_insert_rl", project="octo_finetune")
    ...
    # TODO: load multiple datasets
    logging.info("Loading finetuning dataset...")
    dataset = make_interleaved_dataset(
        dataset_kwargs_list=[
            {
                "name": "vga_insert_rl_dataset",
                "data_dir": "/media/nvmep3p_2/rlds2",
                "image_obs_keys": {"primary": "image_wrist_1"},
            ...
            {
                "name": "ethernet_insert_rl_dataset",
                "data_dir": "/media/nvmep3p_2/rlds2",
                "image_obs_keys": {"primary": "image_wrist_1"},
                "proprio_obs_key": None,
                "language_key": "language_instruction",
    ...
    #     .iterator()
    # )
    train_data_iter = dataset.iterator(prefetch=1)
